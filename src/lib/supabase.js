...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://lqllzavksufpiqefwthy.supabase.co'
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxxbGx6YXZrc3VmcGlxZWZ3dGh5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM3NzY3NTIsImV4cCI6MjA2OTM1Mjc1Mn0.fUOpaX5sMYn9Fdeutc-fyToDwNZjyTrEXi_2v9mwQaA'

export const supabase = createClient(supabaseUrl, supabaseAnonKey)

// Database schema for DriveLine Recruit
/*
